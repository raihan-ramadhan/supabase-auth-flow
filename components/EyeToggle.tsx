  ...
  ({ className, onClick, show, ...props }, ref) => {
    return (
      <span onClick={onClick} className={`size-7 p-1 cursor-pointer flex items-center justify-center ${className}`}>
        {show ? (
          <svg ref={ref} className="size-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 472 384" {...props}>
            <path
              fill="currentColor"
          ...
          <svg ref={ref} className="size-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" {...props}>
            <path
              fill="currentColor"
