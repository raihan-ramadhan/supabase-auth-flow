...
>(({ className, variant = "default", ...props }, ref) => {
  const variantClasses = {
    ...
    destructive: "destructive group border-border bg-red-400 dark:bg-red-700 text-destructive-foreground",
  };
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={`text-sm font-semibold [&+div]:text-xs ${className || ""}`} {...props} />
));
