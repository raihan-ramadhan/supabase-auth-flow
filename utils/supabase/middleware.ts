...
export async function updateSession(request: NextRequest) {
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith("/recovery-password-sent") &&
    !request.nextUrl.pathname.startsWith("/magic-link-sent") &&
  ...
  if (
    ...
    // user is logged in and trying to access the sign-in page
    const url = request.nextUrl.clone();
